...
data class RenderSnapshot(
    ...
    val collapseVelocityDpPerSecond: Float = 0f,
    val collapseDirection: Int = 0,
    val collapseRebound: Float = 0f,
    val collapseSecondaryRebound: Float = 0f,
    val collapseEffectsFrozen: Boolean = false,
